...
public class EmployeeController {
    ...
    public ResponseEntity<EmployeeDto> assignEmployeeDepartment(@PathVariable("department_id") Long departmentId,
                                                                  @PathVariable("employee_id") Long employeeId){
        EmployeeDto employeeDto = employeeService.assignEmployeeDepartment(departmentId, employeeId);
        return ResponseEntity.ok(employeeDto);
    }
